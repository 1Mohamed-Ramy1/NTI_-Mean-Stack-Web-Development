...
// var str2 = "JavaScript is awesome JavaScript!";
...
// var replacedStr = str2.replace("JavaScript", "JAVA");
// console.log("Replaced str1:", replacedStr); 
// var replacedAllStr = str2.replaceAll("JavaScript", "JAVA");
// console.log("replacedAllStr = ",replacedAllStr);
...
// console.log(isNaN(x));  //  check on only value
// console.log(isNaN(NaN));  // true


// ========== 3. Getting the absolute value (Math.abs) ((Math :-  buildin object at javascript provide methods and constant at arith operation)) ==========
...
// console.log(Number.isFinite(-Infinity));  // false
// console.log(Number.isFinite("123"));      // false ( check on value and data type)
