...
// var text2 = text.toUpperCase(); // this creates a NEW string
...
// var inputusersearch = "  Aa  "; // Example search term

// var filteredFruits = fruits.filter(function (fruit) {
//   return fruit.toLowerCase().includes(inputusersearch.trim().toLowerCase());
// }); 
// console.log("result = ", filteredFruits);

// ["Apple", "Banana", "Orange", "Banana", "OGrapes"];
...
// nums.toSorted(function (a, b) { return a - b; });
// console.log(nums); // 
// console.log(originalCopy); //  ← original copy unchanged
...
// console.log('new array copy = ',nums.toSpliced(1, 1)); // [3, 2]
// console.log('origin = ',nums);                   // still [3, 1, 2]
...
// var removed = letters.splice(2, 2 , 'r','t');
...
// var ages = [22, 17, 30];
// var returnSome = ages.every(function (val){
//     return val > 18
// })
