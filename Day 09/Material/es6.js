...
// "use strict";
// function duplicateParams(a, b, a ,b ,a ,a) {
//     console.log("a:", a); 
//     console.log("b:", b); 
// }
// duplicateParams(1, 2, 3 ,4,5,6);
...
//     if (true) {
        ...
        // console.log("داخل if - functionVar:", functionVar); // undefined
...
// var stringObj = JSON.stringify(config)
...
// console.log("window.globalFunction:",  window.globalFunction); // "function"
...
// console.log("window.globalLetFunction:",  window.globalLetFunction); // "undefined"
...
// console.log(personShallow.name);

// console.log("person1.son.age:", person1.son.age); // 99 — اتأثر!
// console.log("personShallow.son.age:", personShallow.son.age); // 99 — اتأثر!
